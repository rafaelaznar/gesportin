...
@Component({
  selector: 'app-jugador-plist-finder',
  standalone: true,
  imports: [CommonModule, Paginacion],
  templateUrl: './plist.html',
  styleUrl: './plist.css',
})
export class JugadorPlistFinder implements OnInit, OnDestroy {
  ...
  private readonly modalRef = inject(MODAL_REF, { optional: true }) as ModalRef<unknown, IJugador | null> | null;
