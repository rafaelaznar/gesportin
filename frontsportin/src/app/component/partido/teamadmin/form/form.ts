import { Component, OnInit, AfterViewInit, inject, signal, effect, input } from '@angular/core';
...
export class PartidoTeamadminForm implements OnInit, AfterViewInit {
  id = input<number>(0);
  ...
  private readonly mapContainerId = 'partidoTeamadminLocationMap';
  ...
  ngAfterViewInit(): void {
    this.loadLeafletAssets()
      .then(() => this.initMap())
      .catch((err) => console.error('Error cargando Leaflet en PartidoTeamadminForm:', err));
  ...
  private initMap(): void {
    ...
    // Prevent wrapped world copies appearing at low zoom
    try {
